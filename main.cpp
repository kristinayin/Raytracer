...
initialize(GLFWwindow* _window) {
  ...
  Material m = Material(a_color,d_color,s_color, 10.f);
  Material m2 = Material(a_color3,d_color,s_color, 10.f);
  ...
  Light l(glm::vec3 (2, 5, -5), glm::vec4 (0.1, 0.1, 0.1, 1), glm::vec4 (0.5, 0.7, 0.4, 1), 
